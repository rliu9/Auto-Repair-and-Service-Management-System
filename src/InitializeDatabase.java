	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				rows_affected = createEmployeeUserAccount("12345678", "Mechanic2", "Mechanic123", "Mechanic",
				...
				rows_affected = createEmployeeUserAccount("12345678", "Mechanic3", "Mechanic123", "Mechanic",
																	"000000003", "A", "B", "Mechanic address",
																	"mechanic@email.com", "1234567890", 20, 0);
				if (rows_affected==3) {
					System.out.println("MECHANIC CREATED IN TABLES DB_Users, Employees, Hourly_Emp");
				}

				rows_affected = createEmployeeUserAccount("12345678", "Mechanic4", "Mechanic123", "Mechanic",
																	"000000004", "A", "B", "Mechanic address",
																	"mechanic@email.com", "1234567890", 20, 0);
				if (rows_affected==3) {
					System.out.println("MECHANIC CREATED IN TABLES DB_Users, Employees, Hourly_Emp");
				}
